<template>
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-4 mr-auto lg:flex lg:justify-between lg:items-center">
            <div class="lg:flex lg:items-center">
                <div class="flex items-center justify-between">
                    <div>
                        <a class="text-2xl font-bold text-gray-800 transition-colors duration-200 transform dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300 mr-5" href="#">DX Logger</a>
                    </div>
            ...
            <div class="flex justify-center lg:flex lg:mt-0 lg:-mx-2">
                <div class="px-3 py-1 text-sm font-medium text-gray-100 transform bg-indigo-600 rounded-md hover:bg-indigo-500 md:mx-4 md:my-0">
